                    ...
                    @foreach ($topMovies as $index => $movie)
                        <div class="bg-zinc-900 rounded-lg shadow-md flex flex-col md:flex-row overflow-hidden">
                            ...
                            <div class="relative md:w-1/3">
                                ...
                                <div
                                    class="absolute top-2 left-2 bg-yellow-500 text-black text-xs px-2 py-1 rounded font-bold">
                                    {{ $index + 1 }}
                                </div>
                            </div>
                            ...
                            <div class="p-4 flex flex-col justify-between md:w-2/3">
                                <div>
                                    ...
                                    <p class="text-lg text-gray-300 mb-4 line-clamp-3">
                                        {{ Str::words($movie->synopsis, 15, '...') ?? 'No synopsis available.' }}</p>
                                    <a href="/movie/{{ $movie->id }}/{{ $movie->slug }}" class="btn btn-primary">Read
                                        more</a>
                                </div>
